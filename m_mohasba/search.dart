...
import 'package:my_gradution_project/m_mohasba/test_model/book_model.dart';

class SearchMohasba extends SearchDelegate<ABookModel> {
  @override
...
class SearchFinder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: Hive.box<ABookModel>('abook_box').listenable(),
      builder: (context, Box<ABookModel> contactsBox, _) {
        ...
        return results.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final ABookModel contactListItem = results[index];
