...
import 'package:my_gradution_project/k_ektsad/test_model/book_model.dart';

class SearchWidget extends SearchDelegate<BookModel> {
  @override
...
class SearchFinder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: Hive.box<BookModel>('book_box').listenable(),
        ...
        return results.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final BookModel contactListItem = results[index];
