...
class SearchMedara extends SearchDelegate<MEdaraModel> {
  @override
...
class SearchFinder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: Hive.box<MEdaraModel>('medara_box').listenable(),
      builder: (context, Box<MEdaraModel> contactsBox, _) {
        ...
        return results.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final MEdaraModel contactListItem = results[index];
