...
class SearchKkanon extends SearchDelegate<KanonModel> {
  @override
...
class SearchFinder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: Hive.box<KanonModel>('kanon_box').listenable(),
      builder: (context, Box<KanonModel> contactsBox, _) {
        ...
        return results.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final KanonModel contactListItem = results[index];
