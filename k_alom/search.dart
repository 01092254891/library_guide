...
class SearchAlom extends SearchDelegate<AlomModel> {
  @override
...
class SearchFinder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: Hive.box<AlomModel>('alom_box').listenable(),
      builder: (context, Box<AlomModel> contactsBox, _) {
        ...
        return results.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final AlomModel contactListItem = results[index];
