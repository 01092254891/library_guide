...
class SearchKhasb extends SearchDelegate<HasbModel> {
  @override
...
class SearchFinder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: Hive.box<HasbModel>('hasb_box').listenable(),
      builder: (context, Box<HasbModel> contactsBox, _) {
        ...
        return results.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final HasbModel contactListItem = results[index];
