...
class SearchMektsad extends SearchDelegate<SNoteModel> {
  @override
...
class SearchFinder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: Hive.box<SNoteModel>('snotes_box').listenable(),
      builder: (context, Box<SNoteModel> contactsBox, _) {
        ...
        return results.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final SNoteModel contactListItem = results[index];
