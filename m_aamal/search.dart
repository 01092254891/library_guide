...
class SearchMaamal extends SearchDelegate<AAlomModel> {
  @override
...
class SearchFinder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: Hive.box<AAlomModel>('akalom_box').listenable(),
      builder: (context, Box<AAlomModel> contactsBox, _) {
        ...
        return results.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final AAlomModel contactListItem = results[index];
