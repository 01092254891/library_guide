...
class SearchMhasb extends SearchDelegate<MHasbModel> {
  @override
...
class SearchFinder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: Hive.box<MHasbModel>('mhasb_box').listenable(),
      builder: (context, Box<MHasbModel> contactsBox, _) {
        ...
        return results.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final MHasbModel contactListItem = results[index];
