...
class SearchMalom extends SearchDelegate<MAlomModel> {
  @override
...
class SearchFinder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: Hive.box<MAlomModel>('mkalom_box').listenable(),
      builder: (context, Box<MAlomModel> contactsBox, _) {
        ...
        return results.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final MAlomModel contactListItem = results[index];
