...
class SearchSkafa extends SearchDelegate<SkafaModel> {
  @override
...
class SearchFinder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: Hive.box<SkafaModel>('skafa_box').listenable(),
      builder: (context, Box<SkafaModel> contactsBox, _) {
        ...
        return results.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final SkafaModel contactListItem = results[index];
