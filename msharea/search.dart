...
class SearchMsharea extends SearchDelegate<ANoteModel> {
  @override
...
class SearchFinder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: Hive.box<ANoteModel>('anotes_box').listenable(),
      builder: (context, Box<ANoteModel> contactsBox, _) {
        ...
        return results.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final ANoteModel contactListItem = results[index];
