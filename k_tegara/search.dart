...
class SearchTegara extends SearchDelegate<TegaraModel> {
  @override
...
class SearchFinder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: Hive.box<TegaraModel>('tegara_box').listenable(),
      builder: (context, Box<TegaraModel> contactsBox, _) {
        ...
        return results.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final TegaraModel contactListItem = results[index];
